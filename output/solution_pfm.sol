...
<CPLEXSolution version="1.2">
 ...
 <quality
   ...
   kappa="7.5"/>
 <linearConstraints>
  <constraint index="0" status="LL" slack="0" dual="-0"/>
  <constraint index="1" status="LL" slack="0" dual="1"/>
  <constraint index="2" status="LL" slack="0" dual="-0"/>
  <constraint index="3" status="LL" slack="0" dual="-0"/>
